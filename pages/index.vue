          ...
          <div class="row">
            <div class="col-lg-7">
              <div class="hero-header-inner animated zoomIn">
                <p class="fs-4 text-dark" style="font-size: 3rem">WELCOME TO THEMosque</p>
          ...
          <div class="container text-center bg-primary py-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="row g-4 align-items-center">
              ...
              <div class="col-lg-7 text-center text-lg-start">
                <h1 class="mb-0" style="color: white!important;">Every Muslim Needs To Realise The Importance Of The "Pillar" Of Islam</h1>
              </div>
              <div class="col-lg-3">
      ...
      <div class="container-fluid event py-5">
        <div class="container py-5">
          ...
          <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="col-9 col-lg-6 border-start border-dark pb-5">
              <div class="ms-3">
                ...
                <a href="#" class="btn btn-success px-3">Join Now</a>
              </div>
            </div>
            <div class="col-12 col-lg-4">
              <div class="overflow-hidden mb-5">
                <img src="/assets/img/events-1.jpg" class="img-fluid w-100" alt="">
              </div>
            </div>
          </div>
          <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="col-12 col-lg-4">
              <div class="overflow-hidden mb-5">
                <img src="/assets/img/events-2.jpg" class="img-fluid w-100" alt="">
              </div>
            </div>
          </div>
          <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">
            ...
            <div class="col-12 col-lg-4">
              <div class="overflow-hidden mb-5">
                <img src="/assets/img/events-3.jpg" class="img-fluid w-100" alt="">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-4 justify-content-center">
            <div class="col-lg-6 col-xl-4">
              <div class="sermon-item wow fadeIn" data-wow-delay="0.1s">
                <div class="overflow-hidden p-4 pb-0">
                  <img src="/assets/img/sermon-1.jpg" class="img-fluid w-100" alt="">
                </div>
                <div class="p-4">
                  <div class="sermon-meta d-flex justify-content-between pb-2">
                    <div class="">
                      <small>
                        ...
                        <a href="" class="text-muted me-2">13 Nov 2023</a>
                      </small>
                      <small><i class="fas fa-user me-2 text-muted"></i><a href="" class="text-muted">Admin</a></small>
                    </div>
                    <div class="">
            ...
            <div class="col-lg-6 col-xl-4">
              <div class="sermon-item wow fadeIn" data-wow-delay="0.3s">
                <div class="overflow-hidden p-4 pb-0">
                  <img src="/assets/img/sermon-2.jpg" class="img-fluid w-100" alt="">
                </div>
                <div class="p-4">
                  <div class="sermon-meta d-flex justify-content-between pb-2">
                    <div class="">
                      <small><i class="fa fa-calendar me-2 text-muted"></i><a href="" class="text-muted me-2">13 Nov 2023</a></small>
                      <small><i class="fas fa-user me-2 text-muted"></i><a href="" class="text-muted">Admin</a></small>
                    </div>
                    <div class="">
                      <a href="" class="me-1"><i class="fas fa-video text-muted"></i></a>
            ...
            <div class="col-lg-6 col-xl-4">
              <div class="sermon-item wow fadeIn" data-wow-delay="0.5s">
                <div class="overflow-hidden p-4 pb-0">
                  <img src="/assets/img/sermon-3.jpg" class="img-fluid w-100" alt="">
                </div>
                <div class="p-4">
                  <div class="sermon-meta d-flex justify-content-between pb-2">
                    <div class="">
