        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-header-inner animated zoomIn">
              <h1 class="display-1 text-dark">Donate</h1>
        ...
        <div class="row g-4 wow fadeIn" data-wow-delay="0.3s">
          <div class="col-sm-8 offset-2" style="text-align: left">
            <div style="text-align: center">
              <div class="row g-4 wow fadeIn" data-wow-delay="0.3s">
                <div class="col-sm-6">
                  <input type="text" class="form-control bg-transparent p-3" placeholder="Purpose (optional)">
                </div>
                <div class="col-sm-6">
                  <input type="number" class="form-control bg-transparent p-3" placeholder="Amount" value="5" readonly>
                </div>
              </div>
              <br>
              <stripe-checkout
...
export default {
  ...
  methods: {
    getSession(){
      this.$axios.get( base_url + 'api/get-session').then((response)=>{
