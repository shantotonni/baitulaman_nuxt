...
<!--          <p class="mb-0">Please enter your contact information to receive emails with important news and updates from BAIS.</p>-->
        ...
        <form @submit.prevent="store()" @keydown="form.onKeydown($event)">
          <div class="row g-4 wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control bg-transparent p-3" :class="{ 'is-invalid': form.errors.has('relation_to_student') }" placeholder="Relationship to Student" v-model="form.relation_to_student">
