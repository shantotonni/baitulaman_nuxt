        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-header-inner animated zoomIn">
              <h1 class="text-dark">Ask The Board</h1>
              <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><nuxt-link to="/">Home</nuxt-link></li>
                <li class="breadcrumb-item text-dark" aria-current="page">Ask The Board</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s">
              <h1 class="display-3">Ask The Board</h1>
              <p class="fs-5 text-uppercase text-primary">Do you have any questions regarding Islam, Quran and Muslims? Our Board will be more than happy to answer your questions.</p>
...
export default {
  ...
  head() {
    return {
      title: "Ask The Board | Baitul Aman"
    };
  },
  data() {
    return {
  ...
  mounted() {
    document.title = 'Ask The Board | Baitul Aman';
  },
  methods: {
    store(){
      this.form.post( base_url + 'api/ask-the-board').then((response)=>{
